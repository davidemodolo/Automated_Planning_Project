(define (domain problem2)
    ...
    (:action move_robot_with_carrier
        ...
        :precondition (and (location_robot ?r ?l1) (location_carrier ?c ?r) (not (= ?l1 ?l2)) (robot_carrier_attached ?r ?c))
        :effect (and 
        ...
        ; move every box
        (forall (?b - box) (and (box_on_carrier ?b ?c) (not (location_box ?b ?l1)) (location_box ?b ?l2)))
        )
    )
    ...
    (:action unload_all_boxes_from_carrier
        ...
        :effect (and (forall (?b - box) (and (box_on_carrier ?b ?c) (box_loaded ?b) (not (box_on_carrier ?b ?c)) (not (box_loaded ?b)) (decrease (num-boxes ?c) 1) (location_box ?b ?l))))
    )
